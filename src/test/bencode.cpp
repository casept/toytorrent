...
TEST(BEncode, parse_string) {
    ...
    ASSERT_EQ(got.value().type, ObjectType::String);
...
TEST(BEncode, parse_integer) {
    ...
    ASSERT_EQ(got.value().type, ObjectType::Integer);
...
TEST(BEncode, parse_dict) {
    ...
    ASSERT_EQ(got.value().type, ObjectType::Dict);
